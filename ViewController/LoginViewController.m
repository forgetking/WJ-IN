...
//                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Herzlich Wilkommen"
//                                                                message:nil
//                                                               delegate:nil
...
- (void) gotoRootViewController {
    ...
    WJRootViewController *rootViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"rootviewcontroller"];
    rootViewController.modalPresentationStyle = UIModalTransitionStyleCrossDissolve;
